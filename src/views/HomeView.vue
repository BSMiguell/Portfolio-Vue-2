    ...
    <v-container fluid>
        ...
        <v-row>
          <v-col cols="5">
            <div style="position: relative" class="mt-16">
              ...
              <h1 class="text-white">I'M Bruno</h1>
              <span class="text-grey">Web Designer & Developer</span><br />
              <v-btn tile dark color="#ff6f00" class="mt-8" variant="outlined"
                >Contact me
              </v-btn>
            </div>
          </v-col>
      ...
      <v-col cols="12" class="mt-16" id="about">
        <div>
          <v-row>
            <v-col cols="12" sm="6">
              <div class="egg">
                <v-img src="i1.png" max-height="200"></v-img>
              </div>
            </v-col>
            ...
            <v-col cols="12" sm="6">
              ...
              <div style="width: 120px">
                <v-slider v-model="slider2" color="#ff6f00"></v-slider>
              </div>

              <h4 class="mt-n4">I Am a Creative Web Design</h4>
              <h4>And Developer</h4>
              <p class="text-grey">
                Hello, My Name Is Bruno I'm 19 I Was Born In Bahia In Salvador I
                Was 7 Years Old I Moved To Rio De Janeiro And I've Lived Here
                For 12 Years I'm Currently Studying Html And Css Js And Py, My
                Hobbies And Playing Games Lol And Being Sad About That I'm Mono
                Aatrox And Main Darius, Kled And Swain, I'm Building This Site
                For Pure Training And Fun.
              </p>
              <br />
              <p class="text-grey">
                Hello, My Name Is Bruno I'm 19 I Was Born In Bahia In Salvador I
              ...
              <v-btn tile dark color="#ff6f00" class="mt-4">
                Download Resume
              </v-btn>
            </v-col>
          </v-row>
          ...
          <v-row>
            <v-col cols="12">
              <div class="child">
                ...
                <p class="text-grey m1-3 mt-4 text-caption">
      ...
      <v-col cols="12" sm="12" id="services">
        <div class="d-flex justify-center mb-6">
          <v-btn color="#ff6f00" class="mr-2">All</v-btn>
      ...
      <v-col cols="12" sm="12">
        <div class="d-flex justify-center mb-6">
          <v-btn color="#ff6f00" class="mt-4">Load More</v-btn>
        </div>
      </v-col>
          ...
          <v-row>
            <v-col cols="12" sm="4">
              <v-card class="mw-auto" max-width="344" height="">
                <v-img src="i3.png" height="200px" cover></v-img>
                ...
                <v-card-text
                  ...
                  Officiis consectetur minima unde, laudantium, recusandae enim
                  nemo.
                </v-card-text>
              </v-card>
            </v-col>
      ...
      <v-col cols="12" id="biog">
        <div class="hire">
          <v-row>
            ...
            <v-col cols="12" sm="4">
              <v-btn color="#ff6f00" class="mt-15">Hire Me</v-btn>
            </v-col>
          </v-row>
        </div>
      </v-col>
        ...
        <v-row>
          ...
          <v-col cols="12" sm="8">
            ...
            <v-textarea
              ...
              variant="outlined"
            ></v-textarea>
            <v-btn color="#ff6f00" class="mt-2">Submit Now</v-btn>
          </v-col>
        </v-row>
      </v-col>
    </v-container>
